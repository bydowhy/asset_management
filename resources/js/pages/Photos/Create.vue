...
function onFileChange(e: Event) {
    ...
    if (form.file) {
        previewUrl.value = URL.createObjectURL(form.file);
    } else {
...
function submit() {
    ...
    })).post('/photos', { forceFormData: true });
}
</script>
    ...
    <div class="mx-auto max-w-3xl space-y-4 p-4">
        <Card>
            ...
            <CardContent class="space-y-4">
                ...
                <div v-if="previewUrl" class="rounded-lg border p-2">
                    <img :src="previewUrl" class="max-h-64 rounded object-contain mx-auto" />
                </div>
                ...
                <div>
                    <label class="text-sm font-medium">Taken At</label>
                    <Input type="datetime-local" v-model="form.taken_at" />
                </div>
